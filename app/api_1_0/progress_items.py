...
@auth.login_required
def get_progress_items() -> Dict[str, Any]:
...
@auth.login_required
def get_progress_item(progress_item_id: int) -> Dict[str, Any]:
...
@auth.login_required
def edit_progress_item(item_id: int) -> Dict[str, Any]:
...
@auth.login_required
def delete_progress_item(item_id: int) -> Dict[str, Any]:
    progress_item = ProgressItem.query.get_or_404(item_id)
